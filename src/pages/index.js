  ...
  return (
    <>
      <Head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/movieslist/apple-touch-icon.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/movieslist/favicon-32x32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/movieslist/favicon-16x16.png" />
        <link rel="manifest" href="/movieslist/site.webmanifest" />
        <link rel="mask-icon" href="/movieslist/safari-pinned-tab.svg" color="#5bbad5" />
